...
<div class="flex flex-col">
  {#if !solana}
    <button
      class=" px-3 py-2 rounded-md  bg-gray-600  hover:bg-gray-700 text-white font-bold"
  ...
  {:else if $userState.userBalance < nftPrice()}
    <button
      class=" px-3 py-2 rounded-md  bg-gray-600  hover:bg-gray-700 text-white font-bold disabled:bg-gray-400"
      disabled={true}
