<script lang="ts">
  ...
  const TITLE = "Luffy The Rabbit";
  const DESCRTIPTION = "Luffy is the Rabbit that brings 47 whitelist tickets for all potential holders in Solana. So, hold this Luffy the Rabbit and wait for the surprise from Luffy the Rabbit.";
  const DESCRTIPTIONN = "Our main project is dedicated to our children in this NFT community. So, those who buy this NFT have good kids supporting instincts as well as good investing instincts.";
  const HEADER_TITLE = "Hi, I'm Luffy!";
  const HEADER_LINK = "https://luffy.endhonesa.com/";
  ...
  {:else}
    ...
    >
      ...
      <div class="p-6">
        ...
        <div class="text-sm sm:text-md font-semibold pb-5 text-white ">
          {DESCRTIPTION}
        </div>
        <Button {connection} />
        ...
        <div class="flex flex-col pt-3">
          {#if $userState.solanaExplorerLink}
            <a
              ...
              target="_blank"
              class="text-white font-semibold  p-1"
          ...
          <p class="text-white ">This collection part of <a title="Our main project is dedicated to our children in this NFT community. So, those who buy this NFT have good kids supporting instincts as well as good investing instincts." href="https://github.com/the-aha-llf/the-kings-nft/wiki/" target="_blank" class="underline underline-offset-6">The KING's NFT Project</a></p>
        </div>
      </div>
    </div>
  {/if}
